...
_G.packer_plugins = {
  ...
  ["cmp-snippy"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/cmp-snippy",
  ...
  melange = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/melange",
  ...
  ["nvim-snippy"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/nvim-snippy",
